...
function Project() {
  ...
  return (
    ...
    <h1 className="p-8 text-4xl font-semibold font-black font-parameter">PROJECTS..........</h1>
    <div className="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5 ">
      <div className="rounded overflow-hidden shadow-lg bg-white border-1 border-rose-600 ">
        <img className="w-full h-auto " src={excess} alt=" " />
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2">EXCESS FOOD DISTRIBUTION</div>
    ...
    <div className="rounded overflow-hidden shadow-lg bg-white border-1 border-green-600">
      <img class="w-full" src={expense} alt=""/>
      <div class="px-6 py-4 ">
        <div class="font-bold text-xl mb-2">EXPENSE TRACKING USING PYTHON</div>
    ...
    <div class="rounded overflow-hidden shadow-lg bg-white border-1 border-yellow-600">
      <img class="w-full h-" src={object} alt="River"/>
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">OBJECT FOLLOWING ROBOT</div>
        <p class="text-gray-700 text-base">
    ...
    <div class="rounded overflow-hidden shadow-lg bg-white border-1 border-sky-600 ">
      <img class="w-full h-50" src={navathan} alt=""/>
      <div class="px-6 py-4 ">
        <div class="font-bold text-xl mb-2">NAVATHAN 2023</div>
        <p class="text-gray-700 text-base">
    ...
    <div class="rounded overflow-hidden shadow-lg bg-white border-1 border-yellow-600 ">
      ...
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">TODO APPLICATION</div>
        <p class="text-gray-700 text-base">
